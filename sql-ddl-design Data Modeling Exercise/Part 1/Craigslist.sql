...
ALTER TABLE "postsCategories" ADD FOREIGN KEY ("Post_id") REFERENCES "Posts" ("id");

ALTER TABLE "postsCategories" ADD FOREIGN KEY ("Categories_id") REFERENCES "Categories" ("id");
